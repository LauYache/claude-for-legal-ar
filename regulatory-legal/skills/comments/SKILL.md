...
**Argentina:** Argentine regulatory comment periods work differently from US NPRMs. Regulators (AAIP, BCRA, CNV, ENACOM, ANMAT) may publish proyectos de norma or open consultas públicas through Boletín Oficial or their own websites. Comment deadlines are typically set in the publishing resolution. InfoLEG (sistemas.infoleg.gob.ar) tracks published norms but may not capture open comment periods — check the regulator's website directly.
