...
| 6 | **Regulatory** | Does this touch a regulated sector, audience, or jurisdiction? Research the applicable regimes. **Argentina: ENACOM (telecomunicaciones), Ley 25.326 (datos personales), Ley 24.240 (defensa del consumidor), Ley 26.904 (grooming/protección menores online), Ley 22.802 (Lealtad Comercial), Defensoría del Público.** | Same users, same sectors, same jurisdictions as existing product |
...
|---|---|
| **Children / minors** | COPPA (US — operators of services directed to children under 13 or with actual knowledge), CA AADC / state age-appropriate design codes, platform age ratings (ESRB, PEGI), addictive-design scrutiny (NY Safe for Kids Act, CA SB 976 and analogs), FTC endorsement guides for kid-directed influencers **| Argentina: Ley 26.904 (grooming/protección de menores online), Ley 26.061 (protección integral de derechos de niñas, niños y adolescentes), Ley 25.326 Art. 7 (datos sensibles de menores), Defensoría del Público (recomendaciones sobre contenido infantil)** |
...
| **Consumer / retail / marketing** | FTC Act § 5, Made-in-USA rule, Green Guides, CAN-SPAM, TCPA (with TCPA-Shaken/Stir for calls), state auto-renewal (ROSCA, CA ARL, NY GBL § 527-a [consumer] or GOL § 5-903 [B2B services] — verify which applies), state sweepstakes/promotions law **| Argentina: Ley 24.240 (defensa del consumidor — arts. 1-4, 8, 37 cláusulas abusivas), Ley 22.802 (Lealtad Comercial), Ley 25.326 (datos personales — AAIP/AAIP), ENACOM (telecomunicaciones — resoluciones sobre servicios digitales), Ley 26.904 (protección de menores online)** |
