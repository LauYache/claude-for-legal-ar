...
**Argentina — additional regimes:** Ley 24.240 de Defensa del Consumidor (arts. 1, 4, 8, 37 — publicidad engañosa, cláusulas abusivas), Ley 22.802 de Lealtad Comercial (prácticas desleales, comparaciones engañosas), CONAR Argentina (Código de Ética de Autodisciplina Publicitaria — recomendaciones y resoluciones), Defensoría del Público (recomendaciones sobre contenido mediático y publicitario), ENACOM (regulaciones sobre publicidad en servicios de telecomunicaciones). Research the currently operative enforcement posture of each before clearing copy for the Argentine market.
...
**Argentina — disclosure overlays:** Ley 24.240 Art. 4 (información clara y detallada al consumidor), Ley 22.802 (transparencia en prácticas comerciales), CONAR Argentina Código de Ética (capítulos sobre testimonios, influencers, y publicidad comparativa), ENACOM resoluciones sobre publicidad en servicios de telecomunicaciones. Research current enforcement posture before clearing.
