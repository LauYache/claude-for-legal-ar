...
> **Confusion framework is jurisdiction-specific.** The US, EU, and Argentina assess likelihood of confusion and registration conflicts differently. Don't apply the wrong one.
>
> - **US (federal circuits / TTAB):** Multi-factor tests (such as *du Pont* 13-factors for TTAB, *Polaroid* 8-factors for the 2d Circuit, or *Sleekcraft* 8-factors for the 9th Circuit) — analyzing strength of the mark, similarity (sight/sound/meaning), proximity of goods, channels, buyer sophistication, actual confusion, and intent.
> - **EU (Art. 8(1)(b) EUTMR):** Global appreciation — all relevant factors assessed holistically through the eyes of the average consumer. Key differences include greater weight on phonetic similarity, translation equivalents, and "likelihood of association" beyond source confusion.
> - **Argentina (Ley N° 22.362 & INPI):** The analysis of confusing similarity (*cotejo marcario*) focuses on three main dimensions:
>   - *Semejanza gráfica (Visual):* Spelling, length, or letter arrangement.
>   - *Semejanza fonética (Phonetic):* Pronunciation. Highly critical in Spanish.
>   - *Semejanza ideológica (Conceptual):* Similarity in meaning or translation.
>   - *Principio de especialidad (Specialty Principle):* Confusing similarity must occur within the same or related classes, unless the earlier mark is a famous mark (*marca notoria*), which enjoys broader protection.
>   - *Opposition Period:* Publication in the INPI Trademark Bulletin opens a **30-calendar-day window** for third-party oppositions (Art. 12 Ley 22.362).
> - **Other jurisdictions:** If the intake includes a jurisdiction without a framework above, say: "I don't have [jurisdiction]'s confusion framework. Applying the US test would give you a wrong answer that looks right." Never silently apply US doctrine.

Pick based on where the user plans to enforce (practice profile), the TTAB/INPI if the immediate forum is registration, or the primary commercial forum otherwise. Note your pick in the output.
