...
2. Run the intake interview:
   ...
   - **Counterparty** (the other side — may be multiple)
    ...
    - **Matter type (Argentina):** despido (termination) | diferencias salariales (wage differences) | tutela sindical (union protection) | PPC (Procedimiento Preventivo de Crisis, Ley 24.013) | acoso laboral (workplace harassment) | ART (accidentes de trabajo) | enfermedad inculpable | vacaciones no gozadas | diferencias de horas extras | discriminación (Ley 23.592) | teletrabajo (Ley 27.555)
